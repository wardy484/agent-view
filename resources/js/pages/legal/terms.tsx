    ...
    return (
        <>
            ...
            >
                <h2>1. Who we are</h2>
                <p>
                    Nexus-UI (&quot;we&quot;, &quot;us&quot;) is operated by the
                    legal entity behind the service. References to the
                ...
                <p>
                    You are responsible for keeping your credentials and Sanctum
                    tokens confidential. You must be at least 16 years old (or
                    the digital-consent age in your country) to use the Service.
                    You may not share an account between humans.
                </p>
                ...
                <p>
                    ...
                    In short: don&apos;t use the Service to break the law, harm
                ...
                <p>
                    ...
                    workbench. You grant us a limited licence to process, store,
                    cache and render that content only to the extent needed to
                ...
                <ul>
                    <li>
                        ...
                        basis via our payment processor.
                    </li>
                    <li>
                ...
                <p>
                    We aim for high availability and publish a status page, but
                    the Service is provided &quot;as is&quot; and &quot;as
                    available&quot; without warranties of any kind except those
                    that cannot be disclaimed by law.
                </p>

                <h2>8. Limitation of liability</h2>
                <p>
                    To the maximum extent permitted by law, our total liability
                    to you for any claim arising out of the Service is limited
                    to the fees you paid us in the 12 months before the event
                ...
                <h2>9. Termination</h2>
                <p>
                    You can cancel at any time from your billing settings. We
                    can suspend or terminate your account for violations of
                    these terms or the Acceptable Use Policy, with notice where
                    reasonable.
                </p>
                ...
                <p>
                    ...
                    are material we&apos;ll notify you by email or in-product at
                ...
                <p>
                    ...
                    which the operator of the Service is established. Disputes
